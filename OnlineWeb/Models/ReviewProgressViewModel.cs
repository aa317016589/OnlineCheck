...
namespace OnlineCheck.Web.Models
{
    public class ReviewProgressViewModel
    {
        ...
        {
            get { return TotalCount == 0 ? 0 : Convert.ToDecimal((FirstCompleteCount * 100 / TotalCount).ToString("f2")); }
        }
        ...
        {
            get { return TotalCount - FirstCompleteCount; }
        }
        ...
        {
            get { return TotalCount == 0 ? 0 : Convert.ToDecimal((FirstUnCompleteCount * 100 / TotalCount).ToString("f2")); }
        }
        ...
        public ReviewProgressViewModel(string testletsStructId, string testletsNumber, int totalCount, int completeCount,
